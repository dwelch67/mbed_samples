...
//can only be updated when PLL0 is disabled.
    //An N of 3 and M of 50 gives a pllclk of 400MHz. remember the register uses M-1 and N-1
    //otherwise you get a clock slower than you were planning.
    PUT32(PLL0CFG,((3-1)<<16)|((50-1)<<0));
    PUT32(PLL0FEED,0xAA);
    PUT32(PLL0FEED,0x55);
...
//It is very important not to merge any steps above.
    PUT32(PLL0CON,3);
    PUT32(PLL0FEED,0xAA);
    PUT32(PLL0FEED,0x55);
